...
const LearnToEarn = () => {
  return (
    <div className='p-3 rounded-3 col-12 col-md-8'>
        <h3>Learn To Earn</h3>
        <div className='d-flex col-12 gap-3 overflow-x-scroll hidden-scrollba'>
            {
                [...Array(2)].map((_, i) => {
                    return (
                        <div key={i} className='d-grid border rounded-4 overflow-hidden' style={{width: '15rem'}}>
                            <img src={nft} alt="nft" />
                            <div className='p-2 rounded-3 bg-primary mx-auto' style={{marginTop: '-7rem', minWidth: '12rem', height: '6rem', marginBottom: '.5rem'}}>
                                ...
                                <div className='d-flex justify-content-between'>
                                    ...
                                    <button className='m-0 fs-7'>Earn NFT</button>
                                </div>
                            </div>
                        </div>
                    )
